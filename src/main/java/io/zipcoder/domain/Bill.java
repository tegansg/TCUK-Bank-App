...
import io.zipcoder.exceptions.InvalidDateFormatException;
...
public class Bill {
	...
	public void setCreation_date(String creation_date) throws InvalidDateFormatException {
		checkValidDate(creation_date);
		this.creation_date = creation_date;
	}

	public void checkValidDate(String date) throws InvalidDateFormatException {
	...
	public void setPayment_date(String payment_date) throws InvalidDateFormatException {
	...
	public void setUpcoming_date_payment(String upcoming_date_payment) throws InvalidDateFormatException {
